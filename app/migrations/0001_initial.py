# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-10-05 16:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 207300))),
            ],
            options={
                'verbose_name': 'Agente',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 203881))),
            ],
        ),
        migrations.CreateModel(
            name='Base',
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 200935))),
            ],
        ),
        migrations.CreateModel(
            name='Campania',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateTimeField(db_column='fecha cargada', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 195799))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 184940))),
            ],
        ),
        migrations.CreateModel(
            name='DBlaster',
            fields=[
                ...
                ('evento', models.ForeignKey(blank=True, db_column='evento', null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Campania')),
            ],
            options={
                'db_table': 'd_blaster',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(blank=True, max_length=100)),
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 193353))),
            ],
        ),
        migrations.CreateModel(
            name='Estadocampania',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(blank=True, max_length=100)),
                ('fecha', models.DateTimeField(db_column='fecha', default=datetime.datetime(2018, 10, 5, 16, 20, 36, 183022))),

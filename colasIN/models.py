...
class Produccion(models.Model):
    ...
    estado= models.ForeignKey(Status,max_length=1000,blank=True, null=True, related_name='_status')
    ...
    zona=models.ForeignKey(Distrito,help_text='Distrito',max_length=1000,blank=True, null=True,related_name='_nombre')
